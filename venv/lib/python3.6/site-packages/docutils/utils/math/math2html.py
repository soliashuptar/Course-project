...
class Options(object):
  ...
  def showoptions(self):
    ...
    Trace.error('    --directory "img_dir":  look for assets in the specified directory')
    Trace.error('    --destdirectory "dest": put converted assets into this directory')
    Trace.error('    --imageformat ".ext":   image output format, or "copy" to copy assets')
    Trace.error('    --noconvert:            do not convert assets, use in original locations')
    Trace.error('    --converter "inkscape": use an alternative program to convert assets')
    ...
    Trace.error('    --googlecharts:         use Google Charts to generate formula assets')
